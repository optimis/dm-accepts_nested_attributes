...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<dm-core>, ["< 1.3", "~> 1.1.0"])
      s.add_development_dependency(%q<dm-validations>, ["< 1.3", "~> 1.1.0"])
      s.add_development_dependency(%q<dm-constraints>, ["< 1.3", "~> 1.1.0"])
      s.add_development_dependency(%q<rake>, ["~> 0.8.7"])
      s.add_development_dependency(%q<rspec>, ["~> 1.3"])
      s.add_development_dependency(%q<yard>, ["~> 0.5"])
      s.add_development_dependency(%q<jeweler>, ["~> 1.5.2"])
    else
      s.add_dependency(%q<dm-core>, ["< 1.3", "~> 1.1.0"])
      s.add_dependency(%q<dm-validations>, ["< 1.3", "~> 1.1.0"])
      s.add_dependency(%q<dm-constraints>, ["< 1.3", "~> 1.1.0"])
